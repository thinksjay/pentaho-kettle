...
public class TextFileInputMeta extends BaseFileInputMeta<TextFileInputAdditionalField, BaseFileInputFiles, BaseFileField>
   ...
   * 自动生成文本中的字段
   */
  public boolean getAutoGenerationFileField() {
    return autoGenerationFileField;
  }

  public void setAutoGenerationFileField(boolean autoGenerationFileField) {
    this.autoGenerationFileField = autoGenerationFileField;
  }
  ...
  public static class Content implements Cloneable {
    ...
    @Injection(name = "ATUO_GENERATION_FILE_FIELD")
    private boolean autoGenerationFileField=true;
    ...
    public TextFileInputMeta() {
        additionalOutputFields = new TextFileInputAdditionalField();
    ...
    public void loadXML(Node stepnode, List<DatabaseMeta> databases, IMetaStore metaStore) throws KettleXMLException {
        try {
            ...
            setAutoGenerationFileField(YES.equalsIgnoreCase(XMLHandler.getTagValue(stepnode, "auto_generation_file_field")));
            additionalOutputFields.fileFieldsField =XMLHandler.getTagValue(stepnode,"file_fields_field");
    ...
    public void setDefault() {
        ...
        inputFiles.isaddresult = true;
        setAutoGenerationFileField(true);
    ...
    public void getFields(RowMetaInterface row, String name, RowMetaInterface[] info, StepMeta nextStep,
        ...
        if (StringUtils.isNotBlank(additionalOutputFields.fileFieldsField)) {
            ValueMetaInterface v = new ValueMetaString(additionalOutputFields.fileFieldsField);
            v.setOrigin(name);
            row.addValueMeta(v);
        }
    }
    ...
    public String getXML() {
        ...
        retval.append("    ").append(XMLHandler.addTagValue("auto_generation_file_field", getAutoGenerationFileField()));
        retval.append("    ").append(XMLHandler.addTagValue("file_fields_field", additionalOutputFields.fileFieldsField));
    ...
    public void readRep(Repository rep, IMetaStore metaStore, ObjectId id_step, List<DatabaseMeta> databases)
        ...
        try {
            ...
            setAutoGenerationFileField(rep.getStepAttributeBoolean(id_step,"auto_generation_file_field"));
            additionalOutputFields.fileFieldsField =rep.getStepAttributeString(id_step,"file_fields_field");
        } catch (Exception e) {
    ...
    public void saveRep(Repository rep, IMetaStore metaStore, ObjectId id_transformation, ObjectId id_step)
        ...
        try {
          ...
          rep.saveStepAttribute(id_transformation, id_step, "auto_generation_file_field", getAutoGenerationFileField());
          rep.saveStepAttribute(id_transformation, id_step, "file_fields_field", additionalOutputFields.fileFieldsField);
        } catch (Exception e) {
